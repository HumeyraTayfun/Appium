...
// kalkis yapilacak ulke/sehir girilir ve sec e tiklanir
        if (!driver.isKeyboardShown()){
            page.kalkisTextKutusu.sendKeys("Ankara");//eger klavyem gözukmuyorsa ankara yaz
        } else {
            driver.getKeyboard().pressKey("Istanbul");//gözüküyorsa istanbul yaz
        }
        Thread.sleep(1500);
...
// en  ucuz ve aktarmasiz filtrelemeleri yapilir
        ResuableMethods.koordinatTiklamaMethodu(252,252,1000);//best
        ResuableMethods.koordinatTiklamaMethodu(563,584,2000);//cheapest
        ResuableMethods.koordinatTiklamaMethodu(519,256,1000);//stop
        ResuableMethods.koordinatTiklamaMethodu(511,1458,3000);//nonstop

// gelen bilet fiyati kaydedilir ve kullanicin telefonuna sms olarak gonderilir
        String biletFiyati=page.sonucFiyat.getText();//fıyat lokatı
